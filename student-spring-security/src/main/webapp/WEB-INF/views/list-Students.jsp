...
<body>
	...
	<div class="container" align="center">
		...
		<!-- Add a search form -->
		<form action="/StudentManagement/students" class="form-inline">

			<!-- Add a button -->
			<a href="/StudentManagement/students"
...
<hr>
		<table class="table table-bordered table-striped">
			...
			<tbody>
				<c:forEach items="${listStudents}" var="tempCustomer">
					<tr>
						...
						<td>
							...
							href="/StudentManagement/students/update?studentId=${tempStudent.id}"
